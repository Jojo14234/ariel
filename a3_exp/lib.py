...
class Experiment:
    ...
    def basic_fitness(_: mj.MjModel, mj_data: mj.MjData):
        return -mj_data.geom('robot1_core').xpos[1]
    ...
    @staticmethod
    def spec_to_simple_world(spec: mj.MjSpec) -> mj.MjSpec:
    ...
    @staticmethod
    def spec_to_olympic_world(spec: mj.MjSpec, position=SPAWN_POS) -> mj.MjSpec:
